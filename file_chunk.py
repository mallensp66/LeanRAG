...
if __name__ == "__main__":
    ...
    original_text_file="ckg_data/mix_chunk3/mix.jsonl" # "datasets/mix/mix.jsonl"
    chunk_text_file="ckg_data/mix_chunk3/mix_chunk.json" # "datasets/mix/mix_chunk.json"
    dataset='mix'
    data=[]
...
#    with open(f'datasets/{dataset}/{dataset}_chunk.json', 'w', encoding='utf-8') as f:
    with open(f'ckg_data/mix_chunk3/{dataset}_chunk.json', 'w', encoding='utf-8') as f:
